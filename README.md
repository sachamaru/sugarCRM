...
* [Monema Phone System Connector](http://monema.es/en/services-telephony-business/sugar-crm-centralita-telefonica.html) - Integrates Monema Phone System with SugarCRM. Allows you to anotate all calls via a popup, it also includes a button for click2dial in all contacts forms and gets info from SugarCRM contacts to show it on your phone display. 
